...
def perform_fedprox(
    ...
    """ Performs the averaging of the local models retrieved from the participating clients
        ...
        Args:
            ...
            eval_every (int): The number of times the client performance on the global test set should be evaluated.
    ...
    for communication_round in range(number_of_training_rounds):
        ...
        # Saves global model if the its performance exceeds the best performing model so far
