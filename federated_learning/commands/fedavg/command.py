...
from federated_learning.src.federated_averaging import perform_federated_averaging


class FedAvgCommand(BaseCommand):
    """Represents a command that represents the federated averaging algorithm."""

    def __init__(self) -> None:
        """Initializes a new FedAvg instance. """
    ...
    def run(self, command_line_arguments: Namespace) -> None:
        ...
        for run in range(command_line_arguments.number_of_runs):
            ...
            torch.use_deterministic_algorithms(mode=True)  # typ
            ...
            central_server_loss, central_server_accuracy = perform_federated_averaging(
