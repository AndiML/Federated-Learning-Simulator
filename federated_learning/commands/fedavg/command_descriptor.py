"""Represents a module that contains the descriptor for the fedavg command."""
...
class FedAvgCommandDescriptor(BaseCommandDescriptor):
    ...
    def get_description(self) -> str:
        ...
        return '''Applies federated averaging'''
    ...
    def add_arguments(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            type=int,
            default=10,
            help="Number of classes the specified neural network architecture outputs"
        )
        parser.add_argument(
            '-g',
            '--use_gpu',
