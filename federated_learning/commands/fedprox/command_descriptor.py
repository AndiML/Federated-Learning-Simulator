...
class FedProxCommandDescriptor(BaseCommandDescriptor):
    ...
    def get_description(self) -> str:
        ...
        return '''Applies federated averaging with regularization'''
    ...
    def add_arguments(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            action='store_true',
            help='''If the switch is set, the weight difference between the local and global model is computed either across all layers or on a
                    layer-wise basis.'''
        )
        parser.add_argument(
            '-g',
