...
from federated_learning.src.fednova import perform_fednova


class FedNovaCommand(BaseCommand):
    """Represents a command that represents the fednova algorithm."""
    ...
    def run(self, command_line_arguments: Namespace) -> None:
        ...
        for run in range(command_line_arguments.number_of_runs):
            ...
            central_server_loss, central_server_accuracy = perform_fednova(
